...
public class MaxEvictableIdleTimeMillisTest {
    // large enough that slow runners don't exceed it before the first shrink
    private static final long MAX_EVICTABLE_IDLE_TIME_MILLIS = 2000;
    ...
    protected void setUp() throws Exception {
        ...
        dataSource.setMaxEvictableIdleTimeMillis(MAX_EVICTABLE_IDLE_TIME_MILLIS);
    ...
    public void test_error() throws Exception {
        ...
        assertNotNull(error);
        assertEquals(MAX_EVICTABLE_IDLE_TIME_MILLIS, dataSource.getMaxEvictableIdleTimeMillis());
    }
    ...
    public void test_max() throws Exception {
        ...
        Thread.sleep(MAX_EVICTABLE_IDLE_TIME_MILLIS + 100);
        dataSource.shrink(true);
